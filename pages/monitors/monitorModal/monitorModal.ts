...
// Correct Modal display and HTML Elemnt access
...
@ViewChild('map') mapElement: ElementRef;
  ...
  constructor(public navCtrl: NavController, public viewCtrl: ViewController, public navParams: NavParams, public loadingCtrl: LoadingController, private dbService: MysqlService, private myApp: MyAppProvider, private ele: ElementRef) {

    console.log("In monitor modal");
...
ngAfterViewInit() {
   // this.ele.nativeElement.parentElement.setAttribute("class",this.ele.nativeElement.parentElement.getAttribute("class")+ "main-view1")
}
